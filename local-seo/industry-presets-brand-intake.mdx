...
You'll find these settings under **Local SEO \> Settings \> Setup \> Brand Voice**. It sits right next to the **Business Details** tab, where you set up your services, hours, and customer pain points - see [Locations & Business Details](/local-seo/locations-business-details) for that part.
...
6. Save. From here on, every Google Business Profile post draws on this context - see [Overview](/local-seo/overview) for how posts are generated and published.

## Related

- [Locations & Business Details](/local-seo/locations-business-details) - set up your business, services, hours, and customer pain points
- [Local SEO Overview](/local-seo/overview) - how posts, reviews, and rankings work together
