...
Local SEO works with your **Google Business Profile** - the listing that shows up in Google Maps and the local "3-pack" when people search for businesses near them. Your profile should already be claimed and verified on Google. If it isn't, see [Google Business Profile](/local-seo/google-business-profile) for how that connection works.
...
> Tip: You can refine this further later, and add deeper brand details (your unique selling points, certifications, tone of voice, and seasonal angles) on the [Industry Presets & Brand Intake](/local-seo/industry-presets-brand-intake) screen.
...
3. **Imports your recent Google reviews** so you can start managing and responding to them right away (see [Reviews](/local-seo/reviews)).
...
Service areas are stored on your location and can be edited any time under **Local SEO \> Settings \> Businesses**. For the full walkthrough of managing addresses, hours, and service areas after onboarding, see [Locations & Business Details](/local-seo/locations-business-details).
...
- [Locations & Business Details](/local-seo/locations-business-details) - manage addresses, hours, service areas, and add more locations.
- [Industry Presets & Brand Intake](/local-seo/industry-presets-brand-intake) - fine-tune your brand voice, USPs, certifications, and seasonal angles so posts sound unmistakably like you.
- [Google Business Profile](/local-seo/google-business-profile) - how theStacc connects to and optimizes your GBP.
