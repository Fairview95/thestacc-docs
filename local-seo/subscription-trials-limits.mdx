...
For how to add and edit the businesses themselves, see [Locations & Business Details](/local-seo/locations-business-details). For changing plans, upgrading, or managing payment, see [Billing & Plans](/account/billing).
...
To upgrade from a trial to a paid plan, or to change plans later, go to **Settings \> Billing**. See [Billing & Plans](/account/billing) for the full walkthrough.
...
- [Locations & Business Details](/local-seo/locations-business-details) - add and edit the businesses in your project.
- [Billing & Plans](/account/billing) - upgrade from trial to paid, change plans, or manage payment.
- [Google Business Profile](/local-seo/google-business-profile) - connect your profile and publish local posts.
