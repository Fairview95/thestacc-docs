...
> Automation only generates for projects that have a publishing platform connected and auto-generation switched on. If neither is set up, your To-be-generated posts wait on the calendar until you generate them yourself. See [Connect Platforms](/docs/integrations/overview).
