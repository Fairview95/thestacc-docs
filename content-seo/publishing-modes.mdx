...
On each post's scheduled date, theStacc writes the blog (text and images) and then **stops and waits for you**. The finished draft lands in your review queue marked **Pending Review**. It does not publish until you approve it. From the review queue you can edit it, approve it (which sends it to your connected destination), or reject it. See [Draft & Approval Workflow](/content-seo/draft-approval-workflow) for how to review, edit, and approve.
...
For setup steps on each platform, see [Publishing](/content-seo/publishing).
...
- [Publishing](/content-seo/publishing) - connect WordPress, Webflow, Ghost, Zepio, Shopify, or a webhook destination.
- [Draft & Approval Workflow](/content-seo/draft-approval-workflow) - review, edit, and approve posts in Draft for me.
- [Automated Generation](/content-seo/automated-generation) - how scheduled, automatic writing works behind Draft for me and Full autopilot.
