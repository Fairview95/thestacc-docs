...
- **Title**
- **Blog type** (the format, such as how-to, listicle, or guide - see [Blog Types](/content-seo/blog-types))
...
For more on how images are created and the styles available across your whole site, see [Image Generation](/content-seo/image-generation).
...
For more on what to do when generation fails and how theStacc recovers automatically, see [AI Error Recovery & Retries](/content-seo/ai-error-recovery).
...
See [Blog Generation](/content-seo/blog-generation) for a full walkthrough of how the pipeline writes a post.
...
- [Blog Generation](/content-seo/blog-generation) - how the AI writes a post end to end.
- [Image Generation](/content-seo/image-generation) - image styles, aspect ratios, and how images are created.
- [AI Error Recovery & Retries](/content-seo/ai-error-recovery) - what happens when generation fails and how theStacc retries.
- [Blog Types](/content-seo/blog-types) - the post formats the AI chooses from.
