...
This is also available to automated agents through theStacc's MCP server, so an assistant can drop a product screenshot straight into a draft in place of an AI image. See [Connect Platforms](/docs/integrations/overview) for more on connecting tools.
