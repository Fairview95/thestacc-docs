...
If a post has no blog type set, this category is scored neutrally rather than penalized - theStacc will not grade you against an expectation you never stated. To learn more about choosing a type, see [Blog Type Options](/docs/content-seo/blog-types).
...
- [Blog Generation](/docs/content-seo/blog-generation) - the full pipeline that writes, scores, and regenerates each post.
- [Blog Type Options](/docs/content-seo/blog-types) - choosing the right type so the search-intent check grades you correctly.
