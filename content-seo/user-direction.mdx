...
The same applies to invented statistics, fake testimonials or customer quotes, and made-up certifications - User Direction can't authorize any of them. For the full list of what's protected and why, see [AI Content Safety & Integrity Guardrails](/docs/how-it-works/quality-safety).
...
- [Blog Generation](/docs/content-seo/blog-generation) - how a post is written end to end, and where your direction fits in.
- [AI Content Safety & Integrity Guardrails](/docs/how-it-works/quality-safety) - the protections that User Direction can't switch off.
