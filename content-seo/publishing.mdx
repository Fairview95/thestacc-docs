...
For step-by-step setup of every platform, including screenshots and field mapping, see [Connect Platforms](/docs/integrations/overview).
...
For the complete request and response contract, HMAC signature verification, timeouts, and ready-to-paste receiver examples, see [Connect Platforms - Custom Webhook](/docs/integrations/overview) and the [Webhook Reference](/docs/developers/webhooks/overview).
...
- [Connect Platforms](/docs/integrations/overview) - step-by-step setup for every supported platform and the custom webhook.
