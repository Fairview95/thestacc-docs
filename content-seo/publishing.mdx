...
For a deeper walkthrough of autopilot, daily auto-generation, and how the cron pipeline schedules and spaces out publishes, see [Publishing Modes & Autopilot](/content-seo/publishing-modes).
...
For step-by-step setup of every platform, including screenshots and field mapping, see [Connect Platforms](/integrations/overview).
...
For the complete request and response contract, HMAC signature verification, timeouts, and ready-to-paste receiver examples, see [Connect Platforms - Custom Webhook](/integrations/overview) and the [Webhook Reference](/developers/webhooks/overview).
...
- [Publishing Modes & Autopilot](/content-seo/publishing-modes) - control whether blogs publish automatically, wait for approval, or stay drafts.
- [Connect Platforms](/integrations/overview) - step-by-step setup for every supported platform and the custom webhook.
- [Publishing Errors & Retries](/content-seo/publishing-errors) - what each publish error means and how to fix it.
- [Internal Linking](/content-seo/internal-linking) - set up the internal links that placeholders resolve to at publish time.
