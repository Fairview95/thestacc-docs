...
- [Preferences](/docs/content-seo/preferences) - set your writing style, image style, CTA links, and other content options.
- [SEO Scoring Explained](/docs/content-seo/seo-scoring) - the full breakdown of how every post is scored, category by category.
