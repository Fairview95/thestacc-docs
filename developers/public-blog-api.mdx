...
This is the **pull** side of theStacc's integrations: your site reads content from us. For an end-to-end walkthrough of wiring it into a specific framework, follow [Static Site Integration](/docs/developers/static-sites/overview).
...
This matches the `your-site.com/blog/<slug>/` URL pattern used throughout the [Static Site Integration](/docs/developers/static-sites/overview) guide. If your blog lives at a different path, you'll want to keep that path as `/blog/` (or adjust your routing accordingly) so resolved internal links point to the right place.
...
- Follow [Static Site Integration](/docs/developers/static-sites/overview) for framework-specific setup (Astro, Next.js, Hugo, and more)
