...
For the read-only key and the public read API, see [Public Blog API](/developers/public-blog-api).
...
To understand the stages a blog moves through — generated, pending review, approved, published — see the blog statuses in the [Content SEO overview](/content-seo/overview) and the approval modes in [Publishing](/content-seo/publishing).
...
- [Public Blog API](/developers/public-blog-api) — the read-only key for displaying published posts on any site
- [Webhook Reference](/developers/webhooks/overview) — the payload theStacc sends when a post is published
- [Content SEO overview](/content-seo/overview) — the blog status lifecycle from draft to published
- [Publishing](/content-seo/publishing) — approval modes and connecting your site
