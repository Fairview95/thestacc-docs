...
> **Quick orientation:** if you're configuring this from theStacc's dashboard, start at [Connect Platforms](/integrations/overview) and choose Custom Webhook. This page is for the developer who needs to build (or audit) the receiving endpoint. For what happens when a publish fails and how to recover, see [Publishing Errors & Retries](/content-seo/publishing-errors).
...
If you use WordPress, Webflow, Ghost, Shopify, or Zepio, use those integrations instead — they handle authentication, image uploads, and field mapping for you. See [Connect Platforms](/integrations/overview) for the full list.
