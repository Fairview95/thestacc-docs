...
description: "Automated content is only useful if it is good, consistent, and safe to publish under your name."
---
...
If theStacc detects that a project looks like a regulated business, it may suggest turning the layer on - but it never enables it for you and never blocks your publishing on a hunch. Setup is opt-in. See [Compliance Profiles](/docs/content-seo/compliance-profiles) for how to turn it on and configure it.
...
- [AI Content Safety & Integrity Guardrails](/docs/how-it-works/quality-safety) - the full list of what theStacc will and will not generate, and why these rules cannot be overridden.
- [Compliance Profiles](/docs/content-seo/compliance-profiles) - opt-in setup for regulated businesses, the writing-time disclosures, and the pre-publish review gate.
- [The content engine](/docs/how-it-works/content-engine) - where quality and safety fit into the full generation pipeline.
- [Publishing](/docs/content-seo/publishing) - how review queues and publishing modes work.
