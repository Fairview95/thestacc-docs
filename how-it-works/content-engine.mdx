...
6. **Review and publish** - The draft is saved the moment the writing is done, so you can start reading immediately while images finish in the background. From there it follows your publishing mode - straight to your site, into a review queue, or held as a draft (see [Publishing](/content-seo/publishing)).
...
- **Your business profile** - what you do, who you serve, your locations, services, features, pain points, and competitors. This is the foundation every post is written against. See [Business Setup](/content-seo/business-setup).
...
For more on grounding, brand voice, and the quality checks, see [Quality & safety](/how-it-works/quality-safety).
...
- [Blog Generation](/content-seo/blog-generation) - how to trigger, watch, and edit a generation run.
- [Quality & safety](/how-it-works/quality-safety) - brand voice, grounding, anti-repetition, SEO scoring, and compliance.
- [How the AI works](/how-it-works/how-the-ai-works) - the AI models and generation pipeline behind every stage above.
