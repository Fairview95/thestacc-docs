...
**What to do:** Click **Try again** to re-run generation. (See [Image Generation](/docs/content-seo/image-generation) for which formats are text-only and therefore never carry an image.)
...
- [Content Plans & Generation](/docs/social-media/content-plans-generation) - how posts get created and what each generation step does.
- [Image Generation](/docs/content-seo/image-generation) - how images are produced, sized per platform, branded, and which formats are text-only.
