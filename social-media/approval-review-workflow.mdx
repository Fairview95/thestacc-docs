...
For a full comparison of all three presets and how to switch between them, see [Publishing Modes](/social-media/publishing-scheduling).
...
For what each later state means and how to recover a post that failed to publish, see [Post States & Failures](/social-media/post-states-failures).

## Related

- [Publishing Modes](/social-media/publishing-scheduling) — choose between Full autopilot, Draft for Me, and Manual.
- [Post States & Failures](/social-media/post-states-failures) — every status a post can have and how to fix failures.
- [Content & Scheduling](/social-media/content-scheduling) — create posts, edit captions and images, and set publishing times.
