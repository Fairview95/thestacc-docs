...
If you haven't connected your accounts yet, start with [Connecting Platforms](/social-media/connecting-platforms). For creating, scheduling, and publishing posts, see [Content & Scheduling](/social-media/content-scheduling).
...
- **A connection shows Expired, Revoked, or Error** → click **Reconnect** on its card (see [Connecting Platforms](/social-media/connecting-platforms)).
...
- **Publishing tells you a connection is no longer valid** → reconnect the named platforms, then publish again. See [Content & Scheduling](/social-media/content-scheduling).
