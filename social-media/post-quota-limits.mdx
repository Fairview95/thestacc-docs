...
Your post allowance comes from your plan. Every paid Social Media plan includes a number of posts per cycle, and that number is attached to the plan itself - not to a single project setting you can change. Higher plans simply include more posts. For the exact number included with each plan, see [Billing & Plans](/account/billing) and the [pricing page](https://thestacc.com/pricing/).
...
- **Upgrade your plan** for a larger per-cycle allowance. See [Billing & Plans](/account/billing) to compare and change plans - upgrades take effect immediately.
...
- [Billing & Plans](/account/billing) - what each plan includes, trials, and how to upgrade.
- [Content Plans & Generation](/social-media/content-scheduling) - how content plans, pillars, scheduling, and post generation work.
