...
Your post allowance comes from your plan. Every paid Social Media plan includes a number of posts per cycle, and that number is attached to the plan itself - not to a single project setting you can change. Higher plans simply include more posts. For the exact number included with each plan, see [Billing & Plans](/docs/account/billing) and the [pricing page](https://thestacc.com/pricing/).
