...
If a post still needs sign-off first, see [Approval & Review Workflow](/social-media/approval-review-workflow). To check the live state of a post after it ships, see [Post States & Failures](/social-media/post-states-failures).
...
For what each of these states means and how to recover from a failure, see [Post States & Failures](/social-media/post-states-failures).
...
- [Approval & Review Workflow](/social-media/approval-review-workflow) - how the **Draft for Me** review step works, and how to approve, edit, or reject a post before it publishes.
- [Connection Management & Sync](/social-media/connection-management-sync) - connecting accounts, fixing expired connections, and re-syncing a post's live state.
- [Post States & Failures](/social-media/post-states-failures) - what each status means and how to retry a failed or partially published post.
