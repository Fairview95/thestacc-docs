...
- **Write per-platform captions for the short networks.** A single caption that fits LinkedIn's 3,000 characters won't fit X's 280. Use a tighter override for X, Bluesky, and Threads. See [Content & Scheduling](/social-media/content-scheduling) for how to set per-platform captions.
...
- **Mark your X account as Premium** if you have it, so you get the full 25,000-character budget instead of the 280 default. You set this under [Connecting Platforms](/social-media/connecting-platforms).

## Related articles

- [Content & Scheduling](/social-media/content-scheduling) - edit captions, add per-platform overrides, and schedule your posts.
- [Connecting Platforms](/social-media/connecting-platforms) - connect X, Instagram, Facebook, and LinkedIn, and set your X account tier.
