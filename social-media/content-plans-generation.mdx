...
For what happens *after* a post is generated — editing captions, refining images, fixing a failed post — see [Post Customization](/social-media/post-customization), [Image Generation](/content-seo/image-generation), and [Post States & Failures](/social-media/post-states-failures).
...
- [Post Customization](/social-media/post-customization) — edit captions, hashtags, schedule, and platforms after generation.
- [Image Generation](/content-seo/image-generation) — how visuals and carousels are created and refined.
- [Post States & Failures](/social-media/post-states-failures) — every post status and how to recover from failures.
